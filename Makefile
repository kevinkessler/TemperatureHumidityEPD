##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.27.0] date: [Thu Apr 12 22:32:02 EDT 2018] 
##########################################################################################################################
...
flash:
	$(OPENOCDPATH)/bin/openocd -f $(OPENOCDPATH)/scripts/interface/stlink-v2-1.cfg -f $(OPENOCDPATH)/scripts/target/stm32l0.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"
